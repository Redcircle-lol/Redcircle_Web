...
No. RedCircle covers the launch cost and signs the transaction server-side, so launching is free and gasless for you. You only pay standard network and trading fees when buying or selling.
...
Any wallet compatible with the Solana wallet adapter standard, including Phantom and Solflare.
