...
You need two things to use RedCircle to its fullest.

## 1. Connect a Solana wallet

RedCircle supports the standard Solana wallet adapters (Phantom, Solflare, and others). Your wallet is used to trade tokens and to receive creator or curator rewards in USDC. Click **Connect Wallet** in the navbar.
