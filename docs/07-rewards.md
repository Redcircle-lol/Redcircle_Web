...
The original Reddit author earns **0.50% of every trade**. To claim, sign in with the Reddit account that authored the post and submit your Solana wallet — RedCircle verifies that your Reddit username matches the post's author before transferring your accrued USDC balance.
...
If a curator wallet was registered at launch, that wallet earns a configurable share of fees for surfacing the post. The curator claims by proving control of the exact wallet registered at launch — no Reddit login required, because the wallet itself is the identity.
