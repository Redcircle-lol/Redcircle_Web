					...
					<AnimatePresence mode="wait">
						{isSuccess ? (
							...
							>
								...
								<div className="flex w-full gap-2 items-center bg-white/10 backdrop-blur-xl rounded-full border border-white/15 shadow-xl shadow-black/20 p-1.5 transition-all duration-300 focus-within:border-orange-500 focus-within:shadow-orange-500/10">
									<input
										...
										className="flex-1 bg-transparent border-none outline-none px-5 py-3 text-base text-white placeholder:text-neutral-500"
